...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-black bg-opacity-70 dark:bg-opacity-90 backdrop-blur-md pt-12 pb-6 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-800 dark:text-gray-100">HabitLeague</span>
            </div>
            <p className="text-gray-600 dark:text-gray-300">Build Better Habits Together</p>
          </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Connect</h3>
            <div className="space-y-2 text-gray-600 dark:text-gray-300">
              <p className="flex items-center">
                ...
                <a href="mailto:support@personalhabitleague.com" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">support@personalhabitleague.com</a>
              </p>
              <p className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="https://twitter.com/HabitLeague" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">@HabitLeague</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-sm">
            Page loaded on: <span id="timestamp" className="text-gray-500 dark:text-gray-400">{timestamp}</span>
          </p>
        </div>
      </div>
    </footer>
